...
import com.insoftbumdesku.passenger.models.FirebaseToken;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText phone, nama, kota, email, password, numOne, numTwo, numThree, numFour, numFive, numSix, referalcode;
...
//sendcode-----------------------
    ...
    private void upload(final String check) {
        ...
        request.setRefcode(referalcode.getText().toString());
