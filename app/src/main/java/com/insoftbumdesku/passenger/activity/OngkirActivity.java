...
import com.insoftbumdesku.passenger.adapter.CityAdapter;
import com.insoftbumdesku.passenger.adapter.ExpedisiAdapter;
import com.insoftbumdesku.passenger.adapter.ProvinceAdapter;
import com.insoftbumdesku.passenger.api.ApiService;
import com.insoftbumdesku.passenger.api.ApiUrl;
import com.insoftbumdesku.passenger.models.city.ItemCity;
import com.insoftbumdesku.passenger.models.cost.ItemCost;
import com.insoftbumdesku.passenger.models.expedisi.ItemExpedisi;
import com.insoftbumdesku.passenger.models.province.ItemProvince;
import com.insoftbumdesku.passenger.models.province.Result;
...
public class OngkirActivity extends AppCompatActivity {
    ...
    private List<com.insoftbumdesku.passenger.models.city.Result> ListCity = new ArrayList<>();
    ...
    public void popUpCity(final EditText etCity, final EditText etProvince) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Object o = mListView.getItemAtPosition(i);
                com.insoftbumdesku.passenger.models.city.Result cn = (com.insoftbumdesku.passenger.models.city.Result) o;
        ...
        call.enqueue(new Callback<ItemCity>() {
            ...
            public void onResponse(Call<ItemCity> call, Response<ItemCity> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    int count_data = response.body().getRajaongkir().getResults().size();
                    for (int a = 0; a <= count_data - 1; a++) {
                        com.insoftbumdesku.passenger.models.city.Result itemProvince = new com.insoftbumdesku.passenger.models.city.Result(
